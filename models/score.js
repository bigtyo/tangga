...
exports.getScore = function(userid,gameid,callback){
	var data = {};
...
exports.newScore = function(userid,gameid,callback){
	var data = {};
	var insert = "INSERT INTO score(gameid,user_id,score) values("+gameid+",'"+userid+"',0)";
